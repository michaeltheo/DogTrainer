...
export default async function DogAdventuresPage({params}: {params: Promise<{locale: string}>}) {
  const {locale} = await params;
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={idx} className="flex items-start p-6 bg-purple-50 rounded-lg" data-aos="fade-up" data-aos-delay={idx * 100}>
