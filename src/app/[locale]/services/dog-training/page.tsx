...
export default async function DogTrainingPage({
  ...
  return (
    <>
      ...
      <section className="bg-linear-to-br from-primary-100 to-primary-200 py-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={idx}
                className="flex items-start p-6 bg-primary-50 rounded-lg"
                data-aos="fade-up"
                data-aos-delay={idx * 100}
              >
                <svg
                  className="w-6 h-6 text-primary-600 mr-4 shrink-0 mt-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
