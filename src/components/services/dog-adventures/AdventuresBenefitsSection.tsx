        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-block mb-4">
              <div className="bg-gray-100 text-gray-900 px-4 py-2 rounded-full text-sm font-semibold uppercase tracking-wider">
                {t("benefits.badge")}
              </div>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl transition-all duration-300 hover:bg-gray-100"
                  data-aos="fade-up"
