...
const reasons: Reason[] = [
  {
    ...
    titleKey: "whyChooseUs.safe.title",
    descriptionKey: "whyChooseUs.safe.description",
  },
  {
    icon: MapPinIcon,
    titleKey: "whyChooseUs.locations.title",
    descriptionKey: "whyChooseUs.locations.description",
  },
  {
    icon: UsersIcon,
    titleKey: "whyChooseUs.groups.title",
    descriptionKey: "whyChooseUs.groups.description",
  },
  {
    icon: HeartIcon,
    titleKey: "whyChooseUs.experienced.title",
    descriptionKey: "whyChooseUs.experienced.description",
  },
];

const AdventuresWhyChooseUsSection = memo(() => {
...
AdventuresWhyChooseUsSection.displayName = "AdventuresWhyChooseUsSection";

export default AdventuresWhyChooseUsSection;
