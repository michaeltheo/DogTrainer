...
const ProgramCard = memo<ProgramCardProps>(({ program, index }) => {
  ...
  return (
    <Card
      className="shadow-xl bg-white hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 h-full border-t-4 border-primary-500 overflow-hidden group"
      data-aos="fade-up"
    ...
    >
      <CardBody className="p-8">
        ...
        <div className="w-20 h-20 rounded-2xl bg-primary-500 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-110 mb-6">
          <Icon className="w-10 h-10 text-black stroke-2" />
        </div>
        ...
        {/* Divider */}
        <div className="w-12 h-1 bg-primary-400 rounded-full group-hover:w-16 transition-all duration-300 mb-4" />
    ...
    <section className="py-16 md:py-24 bg-linear-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16" data-aos="fade-up">
          ...
          <div className="w-24 h-1.5 bg-linear-to-r from-primary-400 via-primary-500 to-primary-600 mx-auto rounded-full mb-6 shadow-lg" />
