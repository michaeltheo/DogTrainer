...
const ServiceCard = memo<ServiceCardProps>(({ service }) => {
  ...
  return (
    ...
    >
      <CardBody className="p-8 flex flex-col items-center text-center gap-4 relative h-full">
        {/* Decorative background gradient on hover */}
        <div className="absolute inset-0 bg-linear-to-br from-orange-50/0 to-orange-100/0 group-hover:from-orange-50/50 group-hover:to-orange-100/30 transition-all duration-500" />

        {/* Icon with Background */}
        <div className="relative z-10 w-24 h-24 rounded-2xl bg-linear-to-br from-orange-100 to-orange-200 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-110 mb-2">
        ...
        {/* Title */}
        <h3 className="relative z-10 text-xl md:text-2xl font-bold text-gray-900 group-hover:text-orange-700 transition-colors duration-300">
          {t(service.titleKey)}
        </h3>
        ...
        {/* Description */}
        <p className="relative z-10 text-gray-700 leading-relaxed grow flex items-center">
